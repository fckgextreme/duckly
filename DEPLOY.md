...
- `FRONTEND_URL` - `https://193.39.68.185` (или `http://193.39.68.185` если без SSL)
- `BASE_URL` - `https://193.39.68.185` (или `http://193.39.68.185` если без SSL)
- `NODE_ENV=production`

**Важно:** Если вы используете IP адрес без SSL, используйте `http://` вместо `https://` в переменных `FRONTEND_URL` и `BASE_URL`.
